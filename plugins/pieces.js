...
Pieces.prototype = {
    ...
    initOptions(options) {
        ...
        toArray(options, ['image', 'text', 'path', 'w', 'h', 'tx', 'ty', 'piecesWidth', 'piecesSpacing', 'extraSpacing', 'angle', 'rotate', 'translate', 'svgWidth', 'svgHeight', 'color', 'backgroundColor', 'backgroundRadius', 'padding', 'opacity', 'fontFamily', 'fontSize', 'fontWeight', 'ghost', 'ghostOpacity']);
